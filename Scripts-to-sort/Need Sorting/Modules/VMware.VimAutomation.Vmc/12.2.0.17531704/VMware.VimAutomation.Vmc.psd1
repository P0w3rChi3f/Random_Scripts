...
RequiredModules = @(
@{"ModuleName"="VMware.CloudServices";"ModuleVersion"="12.2.0.17463756"}
)
...
CmdletsToExport = @('Add-VmcSddcHost','Connect-Vmc','Disconnect-Vmc','Get-AwsAccount','Get-AwsVpcSubnet','Get-VmcClusterEdrsPolicy','Get-VmcOrganization','Get-VmcSddc','Get-VmcSddcCluster','Get-VmcSddcNetworkService','Get-VmcSddcSiteRecovery','Get-VmcSddcSiteRecoveryInstance','Get-VmcService','New-VmcSddc','New-VmcSddcCluster','New-VmcSddcSiteRecoveryInstance','Remove-VmcSddc','Remove-VmcSddcCluster','Remove-VmcSddcHost','Remove-VmcSddcSiteRecoveryInstance','Set-VmcClusterEdrsPolicy','Set-VmcSddc')
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDuXPaOnNCyTDSx
# FgF0k2UGVQHWdJEecZJ2Vr22tNq1UqCCD8swggTMMIIDtKADAgECAhBdqtQcwalQ
...
# HDAaoRiAFmh0dHA6Ly93d3cudm13YXJlLmNvbS8wLwYJKoZIhvcNAQkEMSIEIDtx
# fxSNiGLdcG7Y82CC3IaNlPgAezm5sc6AC0jSL1miMA0GCSqGSIb3DQEBAQUABIIB
# AC7Jgg2SH57KOQKAG47vDOo8i5U7/aPsDIPYgUM36KyGzRqHmo2SpgAjLaDs5ToG
# t+eaOrD4PZKEd2umL3hy+ar7OT69qK6eBcy0pKyz3hPGris2xumSztAGL86fNAsU
# CAWNpvyOpIO7oMzcaywnAlEW6JVtShZBZyNewA66wIYZOHCZCpO9N2ToOUMHMEbZ
# Ti4vKUn2Kh/z6cwqpMsHoaNelcxXFTN3SCf+4KprhCpxrxHsz9vK0IBRBsWCcbTL
# GgMPXjkNvNpVWdFJvbc3pi2w8FwG/bRaCKafXHMr1myDTQ/nrzkqmVTgGJVJsjAZ
# VK6yMV48eMmCJPOtP9OH132hgg1FMIINQQYKKwYBBAGCNwMDATGCDTEwgg0tBgkq
# hkiG9w0BBwKggg0eMIINGgIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJ
# EAEEoGkEZzBlAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQg4ZpjZ2Pt
# WApGqSd7394YRq9JOPv2fwnHEp3VNI0AyC0CEQC6QmknK9K7nY4DpWg3ULnIGA8y
# MDIxMDEyODIyMzQzNlqgggo3MIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw
...
# hkiG9w0BCQUxDxcNMjEwMTI4MjIzNDM2WjArBgsqhkiG9w0BCRACDDEcMBowGDAW
# BBTh14Ko4ZG+72vKFpG1qrSUpiSb8zAvBgkqhkiG9w0BCQQxIgQgo9in9EvbtCxt
# ufP/dub0VsNopsLKwGO4CksogBMNUb4wDQYJKoZIhvcNAQEBBQAEggEAHPFVkp/c
# Ot8cVSmKq9amRHbroF3vhpGgbvD/DkI8sI6VeZFBI1r918wMezk3eNHz6WfMGSaZ
# otD7Z7VxCc9UADgmr10cA9bZY4OefUm7jXdGI+bceUGmH0kYtW0ibuWoog7mvjPr
# aVTeKRd9xdADEP5wlIwEMyK7TTMG7p7u2jp6hTX+8eMA5dOqVTvGF5T/5Td9nWxl
# lUMuqklWZNJKeTMB3+LsEHm/EAZ/ryTu1Vc3IvMVT/IFggEY9hXgIxao9GXNQ+2I
# PQF1Sxw76omyCd5xP9PKT237zt6J2BSwVosQf+jhIk6XITQzXQ6lF0Ky7gqd4I4K
# Afgc4/mFioltxQ==

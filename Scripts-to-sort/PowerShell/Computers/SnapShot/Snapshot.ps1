...
Get-ChildItem env:\ | WriteOut -FileName Environment-Variables
...
Get-NetTCPConnection -State Listen | Sort-Object LocalPort | WriteOut -FileName Network-TCP-Listening-Ports
Get-NetUDPEndpoint | Sort-Object LocalPort | WriteOut -FileName Network-UDP-Listening-Ports
